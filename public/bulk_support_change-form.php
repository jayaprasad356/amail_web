    ...
    <div class="row">
        <div class="col-md-8">
            <div class="alert alert-info">
                <p>Always download the sample file and upload the CSV file.</p>
            </div>
            <div class="box box-primary">
                ...
                <form method="post" id="add_form" action="public/db-operation.php" enctype="multipart/form-data">
                    ...
                    <div class="box-footer">
                        ...
                        <a class='btn btn-info' href='library/users_format.csv' download='users_format.csv'>
                            <em class='fa fa-download'></em> Download Sample File
                        </a>
                    </div>
                    <div class="form-group">
