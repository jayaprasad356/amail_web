...
$db->connect();
	...
	$sql_query = "SELECT u.id AS id,u.*,u.name AS name,u.mobile AS mobile,u.worked_days,e.name AS support_name,s.name AS lead_name,b.name AS branch_name FROM `users` u $join";
	$db->sql($sql_query);
